...
Container-reuse **без изменений** относительно v1.1.1 (`qaguru/webdriver-chrome:149`, shm 2g, loopback `127.0.0.1:14441/14442`). Compose/orchestrator binary не трогали.
