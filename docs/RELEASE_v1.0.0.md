...
First git tag. Orchestrator already served box1 WARM metrics; this cut adds the hub-attach reserve filter.
...
Hub-attach: [HUB-ATTACH.md](https://github.com/qa-guru/selenoid/blob/main/docs/HUB-ATTACH.md)
