...
| Изменение | Описание |
|-----------|----------|
| **Box1 hub-attach** | `docker-compose.hub.yml` publishes `127.0.0.1:14441/14442→4444`; `config.hub.yaml` sets `webdriver_url_loopback`. Slots: `qaguru/webdriver-chrome:149-min`. |
